                    ...
                    <div class="uk-width-expand@m uk-flex">
                        <div class="uk-grid uk-flex-center">
                            ...
                            <div class="uk-width-2-5@m">
                                <div class="in-padding-horizontal" style="margin-top:100px; margin-bottom:100px;">
                                    <!-- module logo begin -->
                                    ...
                                    <p class="uk-text-small uk-margin-remove-top uk-margin-medium-bottom"> Already have
                                        an account? <a href="{{ route('login') }}" style="color: #1F76BB">Login
                                            here</a></p>
                                    ...
                                    <form class="uk-grid uk-form" method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="uk-margin-small uk-width-1-1 uk-inline">
                                            ...
                                            <input id="firstname" class="uk-input uk-border-rounded" type="text"
                                        ...
                                        <div class="uk-margin-small uk-width-1-1 uk-inline">
                                            ...
                                            <input id="lastname" class="uk-input uk-border-rounded" type="text"
                                        ...
                                        <div class="uk-margin-small uk-width-1-1 uk-inline">
                                            ...
                                            <input id="username" class="uk-input uk-border-rounded" type="text"
                                        ...
                                        <div class="uk-margin-small uk-width-1-1 uk-inline">
                                            ...
                                            <input id="email" class="uk-input uk-border-rounded" type="email"
                                                name="email" :value="old('email')" required />
                                        </div>

                                        <div class="uk-margin-small uk-width-1-1 uk-inline">
                                            <label for="phone"> Phone: </label>
                                            <input id="phone" class="uk-input uk-border-rounded" type="text"
                                        ...
                                        <div class="uk-margin-small uk-width-1-1 uk-inline">
                                            ...
                                            <input id="password" class="uk-input uk-border-rounded" type="password"
                                                name="password" required autocomplete="new-password" />
                                        </div>

                                        <div class="uk-margin-small uk-width-1-1 uk-inline">
                                            <label for="password_confirmation"> Confirm Password </label>
                                            <input id="password_confirmation" class="uk-input uk-border-rounded"
                                        ...
                                        <div class="uk-margin-small uk-width-auto uk-text-small">
                                            <label><input class="uk-checkbox uk-border-rounded" type="checkbox"
                                                    id="remember_me" name="remember" /> I Agree </label>
                                        </div>

                                        <div class="uk-margin-small uk-width-expand uk-text-small">
                                            <label class="uk-align-right"><a class="uk-link-reset"
                                                    href="{{ url('policy') }}">Privacy Policy </a></label>
                                        </div>
