...
@section('content')
    ...
    <div class="row layout-top-spacing">
        ...
        <div class="col-12 col-md-6 rounded layout-spacing mb-4">
            <div class="py-3 rounded" style="background-image: url('{{ asset('thisfront/DashboardTrading.png') }}')">
                <div class="w-100 mb-mt-5">
                    <p class="h3 text-center">${{ Auth::user()->rbalance + Auth::user()->profit + Auth::user()->bonus }}</p>
                    <p class="text-center">Account Balance</p>
                </div>
                <div class="w-100 mt-5 px-3">
                    <div class="progress" role="progressbar" aria-label="Example with label" aria-valuenow="25"
                        aria-valuemin="0" aria-valuemax="100">
                        <div class="progress-bar bg-light text-dark" style="width: {{ Auth::user()->signal_strenght }}%">
                            {{ Auth::user()->signal_strenght }}%</div>
                    </div>
                    <p class="text-center">Signal Strenght</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 layout-spacing">
            <div class="widget">
                ...
                <div class="input-group pill-input-group">
                    <input class="form-control" id="link" type="text" aria-label="Referral link"
                        value="{{ Auth::User()->referral_link }}" readonly> <button
                        class="input-group-text btn btn-primary" role="button"
                        value="{{ Auth::User()->referral_link }}" onclick="myFunction(this.value)"> <i
