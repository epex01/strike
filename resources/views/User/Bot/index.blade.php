  ...
  <div class="row layout-top-spacing">
    ...
    <section class="pricing-section bg-7 mt-5">
      <div class="pricing pricing--norbu">
        @forelse ($bots as $data)
          <div class="pricing__item">
            <h3 class="pricing__title">{{ $data->name }}

            </h3>
            <div class="mx-auto mt-2 mb-2">
                <img src="{{asset('bot.png')}}" width="100px" height="100px" alt="bot">
            </div>

            <div style="font-size:24px;">${{ $data->amount }} </div>
            <ul class="pricing__feature-list text-center">
                ...
                <li class="pricing__feature"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg> {{ $data->profit }}% Profit</li>
            ...
            <div class="mb-4">
              <a href="{{route('bot.preview', ['id' => encrypt($data->id)])}}" class="pricing__action mx-auto mb-4 btn-sm">Buy Bot</a>
            </div>
          </div>
        @empty
                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4 class="text-center text-info">No Bots Available</h4>
                        </div>
                    </div>
                </div>
            </div>
