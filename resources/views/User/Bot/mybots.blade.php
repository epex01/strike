            ...
            <table id="zero-config" class="table dt-table-hover text-center" style="width:100%">
                ...
                <tbody>
                    @forelse ($bots as $data)
                         <tr>
                            <td><span class="text-info" style="text-transform: uppercase;"> {{$data->transaction_id}}</span></td>

                            <td class="col"> {{ $data->bot_name }} </td>

                            <td class="col">$ {{ $data->amount}} </td>

                            <td class="col"> {{ $data->profit}}% </td>

                            <td class="col"> {{$data->time_left}} </td>
