  ...
  <div class="container-fluid">
      ...
      <div class="edit-profile">
        <div class="row">
          ...
          <div class="col-xl-8">
            <form class="card" method="post" action="{{url('/admin/updateuser/'.$user->id)}}">
              @csrf
                ...
                <div class="row">
                  <div class="col-sm-6 col-md-6">
                    <div class="mb-3">
                      ...
                      <input class="form-control" name="first_name" type="text" value="{{$user->firstname}}">
                    </div>
                  </div>
                  <div class="col-sm-6 col-md-6">
                    <div class="mb-3">
                      <label class="form-label">Last Name</label>
                      <input class="form-control" name="last_name" type="text" value="{{$user->lastname}}">
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6 col-md-4">
                    <div class="mb-3">
                      <label class="form-label">Allow Withdrawal</label>
                      <select class="form-control btn-square" name="allow_withdrawal" required>
                        <option val="{{$user->allow_withdrawal}}">{{$user->allow_withdrawal}}</option>
                  ...
                  <div class="col-sm-6 col-md-6">
                    <div class="mb-3">
                      ...
                      <input class="form-control" name="withdrawal_fee" type="text" value="{{$user->withdrawal_fee}}">
                    </div>
                  </div>
                  <div class="col-sm-6 col-md-6">
                    <div class="mb-3">
                      <label class="form-label">Signal Strenght</label>
                      <input class="form-control" name="signal_strenght" type="text" value="{{$user->signal_strenght}}">
                    </div>
                  </div>
                </div>
              </div>
