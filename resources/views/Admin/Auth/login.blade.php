        ...
        <div class="row">
            <div class="col-xl-12 p-0">
                <div class="login-card">
                    <div>
                        <div><a class="logo text-center" href="{{ url('/') }}"><img class="img-fluid for-light"
                                    width="200px" height="100px" src="{{asset('strikepricetrading.png')}}"
                                    alt="looginpage"><img class="img-fluid for-dark"
                                    src="{{asset('strikepricetrading.png')}}" alt="logo"></a></div>
