          ...
          <div class="card-header">
            ...
            @foreach ($gateway as $data)
                ...
                <div class="card col-xl-3 ">
                  ...
                  <div class="card-body">
                    <div class="text-center">
                    <img src="{{asset('/storage/images/'.$data->image)}}" width="200px" height="200px" class="rounded" alt="gateway Image">
                  </div>
                  &nbsp;
                  ...
                  <div class="card-footer text-center">
                    ...
                    <button class="btn btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#DeleteModal{{$data->id}}"><i class="fa fa-trash"></i></button>
                  </div>
                </div>
