...
<div class="sidebar-wrapper">
          <div>
            <div class="logo-wrapper"><a href="{{url('/')}}"><img class="img-fluid for-light" width="150px" height="50px" src="{{asset('strikepricetrading_icon.png')}}" alt=""><img class="img-fluid for-dark" width="150px" height="60px" src="{{asset('strikepricetrading_icon.png')}}" alt=""></a>
              <div class="back-btn"><i class="fa fa-angle-left"></i></div>
              <div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle" data-feather="grid"> </i></div>
            </div>
            <div class="logo-icon-wrapper"><a href="{{url('/')}}"><img class="img-fluid" width="35px" height="35px" src="{{asset('strikepricetrading_icon.png')}}" alt=""></a></div>
            <nav class="sidebar-main">
              <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  <li class="back-btn"><a href="{{url('/')}}"><img class="img-fluid" width="35px" height="35px" src="{{asset('strikepricetrading_icon.png')}}" alt=""></a>
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{route('admin.kyc.index')}}"><i data-feather="users"></i><span>KYC</span></a></li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{route('admin.bots.index')}}"><i data-feather="server"></i><span>Bots</span></a></li>
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i
                                data-feather="server"> </i><span>Copy Trading</span></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{ route('admin.traders') }}">Traders </a></li>
                            <li><a href="{{ route('admin.user.traders') }}"> Trades </a></li>
                        </ul>
                    </li>
...
//                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{url('admin/settings/logo_settings')}}"><i data-feather="edit"></i><span>Logo/Icon Settings</span></a></li>
                  ...
                  <li class="sidebar-list"><a  class="sidebar-link sidebar-title link-nav" href="{{route('admin.change.password')}}"><i data-feather="log-out"></i><span>Change Password</span></a>

                </li>
                  <li class="sidebar-list"><a onclick="event.preventDefault();document.querySelector('#admin-logout-form').submit(); " class="sidebar-link sidebar-title link-nav" href="#"><i data-feather="log-out"></i><span>Log Out</span></a>
